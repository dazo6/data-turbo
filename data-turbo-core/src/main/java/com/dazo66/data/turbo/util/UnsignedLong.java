...
public final class UnsignedLong extends Number implements Comparable<UnsignedLong>, Serializable {
    ...
    public float floatValue() {
        ...
        // The top bit is set, which means that the float value is going to come from the top 24
        //bits.
    ...
    public double doubleValue() {
        ...
        // The top bit is set, which means that the double value is going to come from the top 53
        //bits.
        ...
        // value. But in the specific case where the bottom two bits of the original number are
        //01, we
