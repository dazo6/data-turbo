...
public final class UnsignedLongs {
    ...
    public static long divide(long dividend, long divisor) {
         ...
         * approximation is
         * guaranteed to be either exact or one less than the correct value. This follows from
         * fact that
    ...
    /**
     * Returns a string representation of {@code x} for the given radix, where {@code x} is
     * treated as
     * unsigned.
     *
    ...
    public static String toString(long x, int radix) {
        checkArgument(radix >= Character.MIN_RADIX && radix <= Character.MAX_RADIX, "radix (%s) " +
                "must be between Character.MIN_RADIX and Character.MAX_RADIX", radix);
        if (x == 0) {
            // Simply return "0"
            return "0";
        } else if (x > 0) {
  ...
  public static long decode(String stringValue) {
    ...
    private static final class ParseOverflowDetection {
         ...
         * unsigned long. This is useful for detecting overflow while parsing a string
         * representation of
         * a number. Does not verify whether supplied radix is valid, passing an invalid radix
         * will give
