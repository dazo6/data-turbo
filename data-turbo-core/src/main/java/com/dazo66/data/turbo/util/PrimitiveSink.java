...
public interface PrimitiveSink {
    ...
    /**
     * Puts the remaining bytes of a byte buffer into this sink. {@code bytes.position()} is the
     * first
     ...
     *
     * <p><b>Warning:</b> This method, which reencodes the input before processing it, is useful
     * only
