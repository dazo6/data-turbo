...
public final class Funnels {
     ...
     * {@link Funnel#funnel
     * funnel} an object to a {@code PrimitiveSink} if there is already a way to write the
     * contents of
     * the object to an {@code OutputStream}.
     *
     * <p>The {@code close} and {@code flush} methods of the returned {@code OutputStream} do
     * nothing,
    ...
    private static class SequentialFunnel<E extends Object> implements Funnel<Iterable<?
            extends E>>, Serializable {
