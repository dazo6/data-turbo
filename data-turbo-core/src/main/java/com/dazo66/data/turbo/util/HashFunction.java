 ...
 *   <li><b>cryptographic:</b> certain hash functions such as are designed to
...
public interface HashFunction {
     ...
     *
     * <p><b>Warning:</b> This method will produce different output than most other languages do
     * when
     ...
     *
     * <p><b>Warning:</b> This method, which reencodes the input before hashing it, is useful
     * only for
     * cross-language compatibility. For other use cases, prefer {@link #hashUnencodedChars},
     * which is
