...
final class DoubleUtils {
    ...
    static double bigToDouble(BigInteger x) {
         ...
         * rounding
         * easier, we pick out the top SIGNIFICAND_BITS + 2 bits, so we have one to help us round
         *  up or
         * down. twiceSignifFloor will contain the top SIGNIFICAND_BITS + 2 bits, and signifFloor
         *  the
        ...
        /*
         * We round up if either the fractional part of signif is strictly greater than 0.5
         * (which is
         * true if the 0.5 bit is set and any lower bit is set), or if the fractional part of
         * signif is
        ...
        bits += signifRounded;
        /*
         * If signifRounded == 2^53, we'd need to set all of the significand bits to zero and add
         *  1 to
