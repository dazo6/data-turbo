...
public final class DoubleMath {
    ...
    static final double[] everySixteenthFactorial = {0x1.0p0, 0x1.30777758p44,
            ...
            0x1.c619094edabffp394, 0x1.3638dd7bd6347p498, 0x1.7cac197cfe503p605,
     ...
     *                                   mode, is either less than {@code Integer.MIN_VALUE} or
     *                                   greater than {@code
     *                                   Integer.MAX_VALUE}
    ...
    public static int roundToInt(double x, RoundingMode mode) {
        ...
        checkInRangeForRoundingInputs(z > MIN_INT_AS_DOUBLE - 1.0 & z < MAX_INT_AS_DOUBLE + 1.0,
                x, mode);
        return (int) z;
    }
     ...
     *                               <li>{@code x}, after being rounded to a mathematical integer
     *                               using the specified rounding
     *                                   mode, is either less than {@code Long.MIN_VALUE} or
     *                                   greater than {@code
     *                                   Long.MAX_VALUE}
     *                               <li>{@code x} is not a mathematical integer and {@code mode}
     *                               is {@link
    ...
    /**
     * Returns the base 2 logarithm of a double value, rounded with the specified rounding mode
     * to an
     * {@code int}.
     *
     ...
     * {@code values}.
     *
     * <p>If these values are a sample drawn from a population, this is also an unbiased
     * estimator of
     ...
     *               (this may cause loss of precision for longs of magnitude over 2^53 (slightly
     *               over 9e15))
     * @throws IllegalArgumentException if {@code values} is empty
     */
    @Deprecated
