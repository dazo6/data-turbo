...
public final class Ints {
     ...
     *
     * <p>More formally, returns the lowest index {@code i} such that {@code Arrays.copyOfRange
     * (array,
     ...
     * @param array  an array of {@code int} values, possibly empty
     * @param target a primitive {@code int} value
     * @return the greatest index {@code i} for which {@code array[i] == target}, or {@code -1}
     * if no
     * such index exists.
     */
    ...
    /**
     * Returns the least value present in {@code list}.
     *
     * @param list a <i>nonempty</i> list of {@code int} values
     * @return the value present in {@code list} that is greater than or equal to every other value
     * in the list
     * @throws IllegalArgumentException if {@code list} is empty
     */
    public static int min(Collection<Integer> list) {
    ...
    /**
     * Returns the greatest value present in {@code list}.
     *
     * @param list a <i>nonempty</i> list of {@code int} values
     * @return the value present in {@code list} that is greater than or equal to every other value
     * in the list
    ...
    public static int constrainToRange(int value, int min, int max) {
        Preconditions.checkArgument(min <= max, "min (%s) must be less than or equal to max (%s)"
                , min, max);
    ...
    /**
     * Returns the {@code int} value whose big-endian representation is stored in the first 4
     * bytes of
    ...
    public static int fromByteArray(byte[] bytes) {
        Preconditions.checkArgument(bytes.length >= BYTES, "array too small: %s < %s",
                bytes.length, BYTES);
     ...
     * written to or read from it. For example, whether {@code list.get(0) == list.get(0)} is
     * true for
     ...
     * @return the integer value represented by {@code string} using {@code radix}, or {@code
     * null} if
    ...
    private static class IntArrayAsList extends AbstractList<Integer> implements RandomAccess,
        ...
        public boolean contains(Object target) {
            ...
            return (target instanceof Integer) && Ints.indexOf(array, (Integer) target, start,
                    end) != -1;
        }
