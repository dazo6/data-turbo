...
public final class LongMath {
     ...
     * values are even integers; this method returns the one that is a multiple of a greater
     * power of
     * two.)
     *
  ...
  public static double roundToDouble(long x, RoundingMode mode) {
    ...
    public static long ceilingPowerOfTwo(long x) {
        ...
        if (x > MAX_SIGNED_POWER_OF_TWO) {
            throw new ArithmeticException("ceilingPowerOfTwo(" + x + ") is not representable as a" +
                    " long");
        }
  ...
  public static long sqrt(long x, RoundingMode mode) {
    ...
    *//*
    ...
    static int log10Floor(long x) {
         ...
         * )), we
         * can narrow the possible floor(log10(x)) values to two. For example, if floor(log2(x))
         * is 6,
         * then 64 <= x < 128, so floor(log10(x)) is either 1 or 2.
         */
        int y = maxLog10ForLeadingZeros[Long.numberOfLeadingZeros(x)];
        /*
         * y is the higher of the two possible values of floor(log10(x)). If x < 10^y, then we
         * want the
     ...
     * {@code BigInteger.valueOf(b).pow(k).longValue()}. This implementation runs in {@code O(log
     * k)}
     * time.
     *
    ...
    public static long divide(long p, long q, RoundingMode mode) {
        ...
        /*
         * Normal Java division rounds towards 0, consistently with RoundingMode.DOWN. We just
         * have to
         * deal with the cases where rounding towards 0 is wrong, which typically depends on the
         * sign of
         * p / q.
         *
    ...
    /**
     * Returns the greatest common divisor of {@code a, b}. Returns {@code 0} if {@code a == 0 &&
     * b ==
     * 0}.
     *
    ...
    public static long gcd(long a, long b) {
        /*
         * The reason we require both arguments to be >= 0 is because otherwise, what do you
         * return on
         * gcd(0, Long.MIN_VALUE)? BigInteger.gcd would return positive 2^63, but positive 2^63
         * isn't an
         * int.
         */
    ...
    public static long checkedMultiply(long a, long b) {
        ...
        int leadingZeros =
                Long.numberOfLeadingZeros(a) + Long.numberOfLeadingZeros(~a) + Long.numberOfLeadingZeros(b) + Long.numberOfLeadingZeros(~b);
        /*
    ...
    public static long saturatedAdd(long a, long b) {
        ...
        if ((a ^ b) < 0 | (a ^ naiveSum) >= 0) {
            // If a and b have different signs or a has the same sign as the result then there
            //was no
            // overflow, return.
            return naiveSum;
        }
    ...
    /**
     * Returns {@code n!}, that is, the product of the first {@code n} positive integers, {@code
     * 1} if
        ...
        switch (k) {
            ...
            default:
                if (n < factorials.length) {
                     ...
                     * denominator accumulators, multiplying the fraction into result when near
                     * overflow.
                     */
                    for (int i = 2; i <= k; i++, n--) {
     ...
     * Returns {@code false} if {@code n} is zero, one, or a composite number (one which
     * <i>can</i> be
    ...
    public static boolean isPrime(long n) {
        ...
        if (n < 66) {
            ...
            long mask =
                    (1L << (2 - 2)) | (1L << (3 - 2)) | (1L << (5 - 2)) | (1L << (7 - 2)) | (1L << (11 - 2)) | (1L << (13 - 2)) | (1L << (17 - 2)) | (1L << (19 - 2)) | (1L << (23 - 2)) | (1L << (29 - 2)) | (1L << (31 - 2)) | (1L << (37 - 2)) | (1L << (41 - 2)) | (1L << (43 - 2)) | (1L << (47 - 2)) | (1L << (53 - 2)) | (1L << (59 - 2)) | (1L << (61 - 2));
    ...
    private enum MillerRabinTester {
        ...
        SMALL {
            ...
            long mulMod(long a, long b, long m) {
                /*
                 * lowasser, 2015-Feb-12: Benchmarks suggest that changing this to UnsignedLongs
                 * .remainder
                 * and increasing the threshold to 2^32 doesn't pay for itself, and adding
                 * another enum
                 * constant hurts performance further -- I suspect because bimorphic
                 * implementation is a
        ...
        LARGE {
            ...
            long mulMod(long a, long b, long m) {
                 ...
                 * accepts any
                 * unsigned long, we don't have to do a mod on every operation, only when
                 * intermediate
